...
class Profile extends Model {
  ...
  const Profile._internal({required this.id, required email, required communicationPref, required owner, createdAt, updatedAt}): _email = email, _communicationPref = communicationPref, _owner = owner, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Profile({String? id, required String email, required CommunicationTypes communicationPref, required String owner}) {
  ...
  Profile copyWith({String? email, CommunicationTypes? communicationPref, String? owner}) {
    return Profile._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'email': _email, 'communicationPref': enumToString(_communicationPref), 'owner': _owner, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'email': _email, 'communicationPref': _communicationPref, 'owner': _owner, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
